...
const Footer: React.FC = () => {
  return (
    <footer className="w-full bg-black text-white pt-10 pb-0 mt-12 shadow-inner">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 border-t border-white/20 pt-8">
          <div>
            ...
            <ul className="space-y-1 text-sm">
              <li>Tel: <a href="tel:+5493462669136" className="hover:text-[#ff6600] transition">+54 9 3462 669-136</a></li>
          ...
          {/* Columna Paraná (comentada temporalmente, sitio exclusivo Venado Tuerto)
      ...
      <div className="w-full bg-white text-black text-center py-1 text-xs font-semibold mt-8">
        Desarrollado por Quvo<br />
